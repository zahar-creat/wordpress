...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220919_twitterbootstrap_c0b4d32746d989da9758_20220919081820_archive.zip';
        const ARCHIVE_SIZE       = '31684019';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'c0b4d32-19081820';
        const SECONDARY_PACKAGE_HASH = '23d5ba9-19081820';
        const VERSION            = '1.5.0';
